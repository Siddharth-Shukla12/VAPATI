...
crop_recommendation_model_path = 'C:/Users/Prajwal/Desktop/Project-VAPATI/models/DT.pkl'
...
def crop_recommend():
    title = 'VAPATI - Crop Recommendation'
    return render_template('form1.html', title=title)

@ app.route('/fertilizer')
def fertilizer_recommendation():
    title = 'VAPATI - Fertilizer Recommendation'
...
def disease_prediction():
    title = 'VAPATI- Disease Detection'
    ...
    if request.method == 'POST':
        ...
        if not file:
            return render_template('form3.html', title=title)
        try:
            img = file.read()
